...
const FavModal = ({ isFavModalOpen, closeModal, closeFavModal, menuData, handleAddToCart, cart, slug  }) => {
    ...
    useEffect(() => {
        const modalElement = document.getElementById('my_modal_10');
    ...
    return (
        <dialog id="my_modal_10" className={`modal modal-bottom sm:modal-middle`} onClick={handleOverlayClick}>
