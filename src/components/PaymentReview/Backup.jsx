...
const PaymentReview = () => {
    ...
    const handleIncrement = () => {
        ...
        updateTotalPrice(235); // Update total price based on the new quantity
    };
        ...
        <main className='bg-[#EFEFEF] h-screen'>
            ...
            <div className='bg-white p-4 m-4 shadow rounded-lg -mt-10 relative z-[1000]'>
                ...
                <div className='flex flex-col items-center my-5'>
                    ...
                    <p className='text-[18px] font-bold'>Order Processing</p>
                        <p className='text-[#FDB92A] text-[18px]'>30 Mins Remaining</p>
            ...
            <div className='bg-white h-32'>
                <div className='flex justify-between items-center px-4 pt-2'>
                    <div>
                        <p className='text-[18px] font-semibold'>Total<span className='text-[12px] text-[#808080] ml-1'>(Incl. VAT)</span></p>
                    </div>
                    <div>
                        <p className='text-[20px] text-[#FDB92A] font-normal'>730 TK</p>
                    </div>
                </div>
                <div className="fixed mt-28 bottom-0 left-1/2 transform -translate-x-1/2 bg-[#3F170A] h-[60px] w-[392px] rounded-lg my-0 flex justify-center items-center px-3 mb-4">
                    <div className='text-white'>Back to menu</div>
                </div>
            </div>
        </main>
