...
const Modal = ({ product, closeModal, handleAddToCart }) => {
    const modalRef = useRef(null);

    // Ensure that product is always defined with default values
    const {
        product_name = '',
        product_price = 0,
        // ... (other properties)
    ...
    //   const [totalPrice, setTotalPrice] = useState(235);

    //   const handleCheckboxChange1 = () => {
    //     setIsChecked1(!isChecked1);
    //     updateTotalPrice(!isChecked1 ? 60 : -60);
    //   };

    //   const handleCheckboxChange2 = () => {
    //     setIsChecked2(!isChecked2);
    //     updateTotalPrice(!isChecked2 ? 60 : -60);
    //   };

    //   const handleIncrement = () => {
    //     setQuantity((prevQuantity) => prevQuantity + 1);
    //     updateTotalPrice(235);
    //   };
    ...
    //     const basePrice = product.product_price || 0; // Use the product's actual price, defaulting to 0 if undefined
    //     const extraFlavorPrice = (isChecked1 ? 60 : 0) + (isChecked2 ? 60 : 0);
    //     const newTotalPrice = basePrice + extraFlavorPrice;
    ...
    //       ...product,
    //       extraFlavor1: isChecked1,
    //       extraFlavor2: isChecked2,
    //       quantity,
    //       totalPrice,
    //     };
                ...
                <form method="dialog">
                    <main className='bg-[#EFEFEF] h-screen'>
                        ...
                        <div className='relative'>
                            <div className="fixed top-0 left-1/2 transform -translate-x-1/2 bg-white h-[6px] w-[146px] rounded my-3 mt-18 z-[2000]"></div>
                            <div className="relative h-[283px] sm:h-[350px] md:h-[400px] lg:h-[450px] bg-cover bg-center flex items-start  rounded-br-xl p-5">
                                {/* Background Image */}
                                <img
                                ...
                                <div className="absolute inset-0 bg-gradient-to-b from-[#000] via-[#3D231A] to-transparent border-b-10 border-[#3D231A] "></div>
                        ...
                        <div className='bg-white p-4 m-4 shadow rounded-lg -mt-10 relative z-[1000]'>
                            <div className='flex justify-between items-center mb-4'>
                                ...
                                <div>
                                    <p className='text-[20px] text-black font-semibold'>{product_price} TK</p>
                                </div>
                            </div>
                            ...
                            <div className='mt-5'>
                                ...
                                <textarea className="textarea w-full textarea-bordered resize-none min-h-[90px]" placeholder=""></textarea>

                            </div>
                        </div>

                        {/* Bottob tab */}
                        <div className="relative btm-nav flex justify-between bg-white h-32">
                            <div>
                                <div className='flex justify-between items-center gap-6'>
                                    <div>
                                        <p className='p-4 bg-[#D9D9D9] items-center flex justify-center rounded-full' 
                                    ...
                                    <div className=''>
                                        <p className='p-4 bg-[#FDB92A] items-center flex justify-center rounded-full' 
                            ...
                            <div>
                                <p o
                                // nClick={handleAddToCartClick} 
                                className='bg-[#3F170A] text-white px-9 py-3 rounded-3xl'>Add to cart</p>
                            </div>
